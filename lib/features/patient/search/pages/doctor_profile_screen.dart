...
import 'package:fire/features/patient/search/widgets/item_tile.dart';
import 'package:fire/features/patient/search/widgets/phone_tile.dart';
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: MainButton(
            text: 'احجز موعد الان',
            onPressed: () {
              pushTo(context, Routes.bookingFormScreen, extra: widget.doctorModel);
            },
          ),
        ),
      ),
